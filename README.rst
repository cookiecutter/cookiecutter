...
* `cookiecutter-django-vue`_: For creating applications with Django and VueJS (+ docker, webpack, yarn and more!)
...
.. _`cookiecutter-django-vue`: https://github.com/vchaptsev/cookiecutter-django-vue
