...
* `cpp_cookiecutter`_: A template for a modern C++ projects with CMake build system, python bindings via pybind11, continuous integration scripts, unit-tests and benchmark code included.
...
.. _cpp_cookiecutter: https://github.com/DerThorsten/cpp_cookiecutter
