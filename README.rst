...
* `cookiecutter-webapp`_: Flask-based web application providing a fully configured virtual machine for development and testing.
...
.. _`cookiecutter-webapp`: https://github.com/ryanolson/cookiecutter-webapp
