...
class TestVCS(unittest.TestCase):
    ...
    def test_git_clone(self):
        ...
        if os.path.isdir('cookiecutter-pypackage'):
            shutil.rmtree('cookiecutter-pypackage', onerror=utils.force_delete)
    ...
    def test_git_clone_checkout(self):
        ...
        if os.path.isdir(git_dir):
            shutil.rmtree(git_dir, onerror=utils.force_delete)
    ...
    def test_git_clone_custom_dir(self):
        ...
        if os.path.isdir('tests/custom_dir1'):
            shutil.rmtree('tests/custom_dir1', onerror=utils.force_delete)
    ...
    def test_hg_clone(self):
        ...
        if os.path.isdir('cookiecutter-trytonmodule'):
            shutil.rmtree('cookiecutter-trytonmodule', onerror=utils.force_delete)
