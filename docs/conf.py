...
#
# cookieninja documentation build configuration file, created by
...
version = cookieninja.__version__
# The full version, including alpha/beta/rc tags.
release = cookieninja.__version__
...
htmlhelp_basename = 'cookieninjadoc'
