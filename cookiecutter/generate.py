...
def generate_dump(project_dir, context, skip_if_file_exists):
    """
    create cookiecutter.json in output directory that consist
    context which generated by cookiecutter
    :param project_dir: The directory to execute the script from.
    :param context: Cookiecutter project context.
...
def generate_files(
    ...
    :param keep_project_on_failure: If `True` keep generated project directory even when
        generation
    :param dump_input: If `True` create cookiecutter.json in output directory that consist
    context which generated by cookiecutter
    """
